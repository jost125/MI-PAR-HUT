...
${OBJECTDIR}/TokenPlacer.o: TokenPlacer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TokenPlacer.o TokenPlacer.cpp
...
${OBJECTDIR}/ConfigurationFactory.o: ConfigurationFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConfigurationFactory.o ConfigurationFactory.cpp
...
${OBJECTDIR}/ConfigurationInterval.o: ConfigurationInterval.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConfigurationInterval.o ConfigurationInterval.cpp
